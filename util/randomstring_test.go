...
import (
	...
	"your_project/util" // TODO: Replace with your actual project path
)
...
func Testrandomstring(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			input:         -5,
			expectedError: nil, // TODO: If your function is expected to return error for negative numbers, replace 'nil' with the expected error
		},
	}
